...
and Bond_Number = {bond_Number.stringToStrSql()}; ");
        ...
        protected override void DataToDb()
        {
            ...
            if (sampleData.Any() || commpanyData.Any())
            {
                ...
                var _Issuer = RatingObject.ISSUER.GetDescription();
                var _Guarantor = RatingObject.GUARANTOR.GetDescription();

                A41Datas.GroupBy(x => new { x.Bond_Number, x.ISSUER })
                    .ToList().ForEach(x =>
                    {
                        var _Bond_Rating = _Bond_Ratings.FirstOrDefault(y => y.Bond_Number == x.Key.Bond_Number);
                        var _Issuer_Rating = _Issuer_Ratings.FirstOrDefault(y => y.Issuer == x.Key.ISSUER);
                        var _Guarantor_Rating = _Guarantor_Ratings.FirstOrDefault(y => y.Issuer == x.Key.ISSUER);
                        var _Bond_Number = x.Key.Bond_Number;
                        #region Bond_Rating 更新資料
                        if (_Bond_Rating != null)
                        {
                            if (!_Bond_Rating.S_And_P.IsNullOrWhiteSpace() &&
                                !sampleData.Any(z =>
                                z.Bond_Number == _Bond_Number &&
                                z.RTG_Bloomberg_Field == "RTG_SP"))
                            {
                                sampleData.Add(saveSample(
                                    _Bond_Rating.S_And_P,
                                    null,
                                    _Bond_Number,
                                    "RTG_SP",
                                    RatingOrg.SP
                            ...
                            if (!_Bond_Rating.Moodys.IsNullOrWhiteSpace() &&
                                !sampleData.Any(z =>
                                z.Bond_Number == _Bond_Number &&
                                z.RTG_Bloomberg_Field == "RTG_MOODY"))
                            {
                                sampleData.Add(saveSample(
                                    _Bond_Rating.Moodys,
                                    null,
                            ...
                            if (!_Bond_Rating.Fitch.IsNullOrWhiteSpace() &&
                                !sampleData.Any(z =>
                                z.Bond_Number == _Bond_Number &&
                                z.RTG_Bloomberg_Field == "RTG_FITCH"))
                            {
                                sampleData.Add(saveSample(
                                    _Bond_Rating.Fitch,
                                    null,
                            ...
                            if (!_Bond_Rating.Fitch_TW.IsNullOrWhiteSpace() &&
                                !sampleData.Any(z =>
                                z.Bond_Number == _Bond_Number &&
                                z.RTG_Bloomberg_Field == "RTG_FITCH_NATIONAL"))
                            {
                                sampleData.Add(saveSample(
                                    _Bond_Rating.Fitch_TW,
                                    null,
                                    _Bond_Number,
                                    "RTG_FITCH_NATIONAL",
                                    RatingOrg.FitchTwn
                        ...
                        #endregion
                        #region Issuer_Rating 更新資料
                        if (_Issuer_Rating != null)
                        {
                            if (!_Issuer_Rating.S_And_P.IsNullOrWhiteSpace() &&
                                !commpanyData.Any(z =>
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Issuer &&
                                z.RTG_Bloomberg_Field == "RTG_SP_LT_FC_ISSUER_CREDIT"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Issuer_Rating.S_And_P,
                                  null,
                                  _Bond_Number,
                            ...
                            if (!_Issuer_Rating.Moodys.IsNullOrWhiteSpace() &&
                                ...
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Issuer &&
                                z.RTG_Bloomberg_Field == "RTG_MDY_ISSUER"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Issuer_Rating.Moodys,
                                  null,
                                  _Bond_Number,
                                  "RTG_MDY_ISSUER",
                                  _Issuer,
                            ...
                            if (!_Issuer_Rating.Fitch.IsNullOrWhiteSpace() &&
                                ...
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Issuer &&
                                z.RTG_Bloomberg_Field == "RTG_FITCH_LT_ISSUER_DEFAULT"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Issuer_Rating.Fitch,
                                  null,
                                  _Bond_Number,
                            ...
                            if (!_Issuer_Rating.Fitch_TW.IsNullOrWhiteSpace() &&
                                ...
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Issuer &&
                                z.RTG_Bloomberg_Field == "RTG_FITCH_NATIONAL_LT"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Issuer_Rating.Fitch_TW,
                                  null,
                                  _Bond_Number,
                            ...
                            if (!_Issuer_Rating.TRC.IsNullOrWhiteSpace() &&
                                ...
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Issuer &&
                                z.RTG_Bloomberg_Field == "RTG_TRC_LONG_TERM"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Issuer_Rating.TRC,
                                  null,
                        ...
                        #endregion
                        #region Guarantor_Rating 更新資料
                        if (_Guarantor_Rating != null)
                        {
                            if (!_Guarantor_Rating.S_And_P.IsNullOrWhiteSpace() &&
                                !commpanyData.Any(z =>
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Guarantor &&
                                z.RTG_Bloomberg_Field == "G_RTG_SP_LT_FC_ISSUER_CREDIT"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Guarantor_Rating.S_And_P,
                                  null,
                                  _Bond_Number,
                                  "G_RTG_SP_LT_FC_ISSUER_CREDIT",
                                  _Guarantor,
                                  RatingOrg.SP
                                ));
                            }
                            if (!_Guarantor_Rating.Moodys.IsNullOrWhiteSpace() &&
                                ...
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Guarantor &&
                                z.RTG_Bloomberg_Field == "G_RTG_MDY_ISSUER"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Guarantor_Rating.Moodys,
                                  null,
                                  _Bond_Number,
                                  "G_RTG_MDY_ISSUER",
                                  _Guarantor,
                            ...
                            if (!_Guarantor_Rating.Fitch.IsNullOrWhiteSpace() &&
                                ...
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Guarantor &&
                                z.RTG_Bloomberg_Field == "G_RTG_FITCH_LT_ISSUER_DEFAULT"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Guarantor_Rating.Fitch,
                                  null,
                                  _Bond_Number,
                                  "G_RTG_FITCH_LT_ISSUER_DEFAULT",
                                  _Guarantor,
                                  RatingOrg.Fitch
                                ));
                            }
                            if (!_Guarantor_Rating.Fitch_TW.IsNullOrWhiteSpace() &&
                                ...
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Guarantor &&
                                z.RTG_Bloomberg_Field == "G_RTG_FITCH_NATIONAL_LT"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Guarantor_Rating.Fitch_TW,
                                  null,
                                  _Bond_Number,
                                  "G_RTG_FITCH_NATIONAL_LT",
                                  _Guarantor,
                                  RatingOrg.FitchTwn
                                ));
                            }
                            if (!_Guarantor_Rating.TRC.IsNullOrWhiteSpace() &&
                                ...
                                z.Bond_Number == _Bond_Number &&
                                z.Rating_Object == _Guarantor &&
                                z.RTG_Bloomberg_Field == "G_RTG_TRC_LONG_TERM"))
                            {
                                commpanyData.Add(saveCommpany(
                                  _Guarantor_Rating.TRC,
                                  null,
                                  _Bond_Number,
                                  "G_RTG_TRC_LONG_TERM",
                                  _Guarantor,
